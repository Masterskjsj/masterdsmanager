...
fun_botOnOff () {
      [[ $(ps x | grep "bot_plus"|grep -v grep | wc -l) = '0' ]] && {
          clear
          echo -e "\E[44;1;37m             INSTALADOR BOT S              \E[0m\n"
          ...
          fun_bot1 () {
  	        [[ ! -e "/etc/SSHPlus/ShellBot.sh" ]] && wget -qO- https://raw.githubusercontent.com/Masterskjsj/masterdsmanager/main/ShellBot.sh > /etc/SSHPlus/ShellBot.sh
  	        cd /etc/SSHPlus
